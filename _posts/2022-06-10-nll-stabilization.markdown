...
Over the period of 2019, lots of shifting happening in the migration from the AST borrowck to the MIR borrowck (NLL). In March, [@matthewjasper](https://github.com/matthewjasper) [enabled](https://github.com/rust-lang/rust/pull/59114) migrate mode in Rust 2015, but with warning emitted instead of errors. [@chrisvittal](https://github.com/chrisvittal) [removed](https://github.com/rust-lang/rust/pull/60513) the mostly unused `-Zborrowck=compare` flag. Then [@Centril](https://github.com/Centril) made a [series](https://github.com/rust-lang/rust/pull/63565) [of](https://github.com/rust-lang/rust/pull/64221) [https://github.com/rust-lang/rust/pull/64790](PRs) that upgraded migrate mode NLL warnings to errors in Rust 2018 and Rust 2015, then finally removed the unused AST borrowck.
